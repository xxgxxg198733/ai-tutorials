...
- AI bias is systematic error that creates unfair outcomes, originating from data, algorithmic design, and deployment contexts.
...
- Multiple fairness definitions exist (demographic parity, equal opportunity, equalized odds, individual fairness) that are often mathematically incompatible.
- Mitigation strategies span pre-processing (data modifications), in-processing (training constraints), post-processing (prediction adjustments), and organizational practices.
- Real-world cases like COMPAS and Amazon's hiring algorithm demonstrate the serious societal impacts of biased AI.
