...
- The three essential ingredients are: high-quality data, a mathematical model, and a learning algorithm
- Supervised learning uses labeled data, unsupervised learning finds hidden patterns, and reinforcement learning learns through trial and error
- Training is the learning phase; inference is the prediction phase — and training requires far more resources
