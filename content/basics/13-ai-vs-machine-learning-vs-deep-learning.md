...
Rule-based systems, also called expert systems, are a classic form of AI that does not involve machine learning. A medical diagnosis expert system might contain thousands of if-then rules encoded by human doctors: IF the patient has symptom A AND symptom B, THEN consider diagnosis C with weight 0.8. These systems were the dominant form of AI in the 1980s and achieved significant commercial success. They are transparent — you can trace exactly why they reached a particular conclusion — but they are brittle and require enormous effort to build and maintain.
...
The term "AI" in popular usage has narrowed over time. When people talk about AI today, they usually mean machine learning, and often specifically deep learning. But it is important to remember that AI is a vast field with many approaches, and what we call AI will likely continue to evolve as the technology advances.

## Machine Learning: Learning from Data

Machine learning is a subset of AI that focuses on systems that learn from data rather than following explicitly programmed rules. Instead of a programmer writing instructions for every possible situation, the system discovers patterns in data and uses those patterns to make predictions or decisions. This approach has proven far more effective than rule-based systems for problems involving perception, language, and complex pattern recognition.
...
- AI is the broadest field, encompassing any technology that enables machines to perform intelligent tasks
- Machine learning is a subset of AI focused on systems that learn patterns from data
- Deep learning is a subset of machine learning using multi-layered neural networks for automatic feature learning
...
- Rule-based and symbolic AI approaches remain valuable for problems requiring transparency and precise control
